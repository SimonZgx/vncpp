...
//    std::string host = "stream-testnet.bybit.com";
    ...
    creation_info.ssl_cert_filepath = nullptr;
    creation_info.ssl_private_key_filepath = nullptr;
